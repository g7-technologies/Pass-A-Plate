...
async componentDidMount() {
  ...
  Signuprequest = () =>{
    ...
    console.log();
    try{
        fetch(`${BasePath}register-sponsor`, {
        method: 'POST',
        headers: {
...
// emailinputhandler=textvalue=>{
//   ///[A-Z0-9._%+-]+@[A-Z0-9.-]+.[A-Z]{2,4}/igm
//     this.setState({email: textvalue.replace(/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/)})
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={{flex:1}}>
              ...
              <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center',margin:10 }}>
                <TouchableOpacity onPress={this._pickImage}>
                  <View style={{alignItems:'center',justifyContent:'center',width:105,height:105,borderRadius:100,backgroundColor:Color.bordercolor}}>
              ...
              <TextInput placeholder='Phone Number' placeholderTextColor={Color.PlaceholderColor} onChangeText={value=>this.setState({phone:value})} keyboardType={'phone-pad'}     value={this.state.phone} style={styles.InputFieldsStyle} />
              ...
              { this.state.isLoading ?
                  ...
                  :
                  <TouchableOpacity  onPress={() => this.checkSignup()} style={{borderWidth:1,borderColor:'#044355',borderRadius:10,padding:5,margin:10}} >
